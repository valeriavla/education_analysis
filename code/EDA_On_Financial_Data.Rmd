...
```{r}
ggplot(df, aes(x=gradrate_ba_6yrs_total, y=endowment_total, color = sector_of_institution)) + 
...
```{r}
ggplot(data_to_analyze, aes(x=gradrate_ba_6yrs_total, y=finances_spent_research, color = sector_of_institution)) + 
...
```
```{r}
ggplot(data_to_analyze, aes(x=gradrate_ba_6yrs_total, y=finances_spent_student_services, color = sector_of_institution)) + 
...
```
```{r}
ggplot(data_to_analyze, aes(x=gradrate_ba_6yrs_total, y=finances_spent_public_service, color = sector_of_institution)) + 
...
```
```{r}
ggplot(data_to_analyze, aes(x=gradrate_ba_6yrs_total, y=finances_spent_academic_support, color = sector_of_institution)) + 
...
```
```{r}
ggplot(data_to_analyze, aes(x=gradrate_ba_6yrs_total, y=finances_spent_instruction, color = sector_of_institution)) + 
  geom_point(aes(size=undergraduate_enrollment, fill = sector_of_institution), colour="white",pch=21) +  labs(y='% Finances Spent on Instruction', x='6-Year Graduation Rate All Students') + ggtitle("Comparing Overall Graduation Rates to\nFinances Spent on Instruction")
```
