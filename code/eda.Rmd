...
df %>% ggplot(aes(x=mean_subgroups)) + geom_boxplot(fill = "#bca0dc") + ggtitle("Percentage of Student Body in Underrepresented Groups*\nfor all 4-Year Colleges in the United States") + xlab("Avg. % of Undergraduate Student Body in Underrepresented Subgroups") + theme_minimal() +  theme(plot.title = element_text(hjust = 0.5)) + geom_vline(xintercept=gtown$mean_subgroups, color='#000080', linetype = "dashed")
